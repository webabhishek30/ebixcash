...
class SelectLandlinePaymentScreen extends StatefulWidget {

  Map<String, dynamic> selectLandlineProvider;
  String accountNumber;

  SelectLandlinePaymentScreen({required this.selectLandlineProvider, required this.accountNumber, super.key});

  @override
  State<SelectLandlinePaymentScreen> createState() => _SelectLandlinePaymentScreenState();
}

class _SelectLandlinePaymentScreenState extends State<SelectLandlinePaymentScreen> {
                  ...
                  children: [
                    ListTile(
                      ...
                      leading: SizedBox(
                        width: 50,
                        height: 50,
                        child: Image.asset(widget.selectLandlineProvider["landlineProviderLogo"]),
                      ),
                      title: Text(widget.selectLandlineProvider["landlineProviderName"], style: const TextStyle(
                          fontFamily: "Montserrat",
                          fontSize: 16,
                      ...
                      subtitle: Text(widget.accountNumber, style: const TextStyle(
                        fontFamily: "Montserrat",
                        fontSize: 16,
                      )),
                    ),
