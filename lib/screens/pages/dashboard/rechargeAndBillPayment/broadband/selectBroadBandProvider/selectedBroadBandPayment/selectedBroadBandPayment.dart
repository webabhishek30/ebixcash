...
class SelectedBroadBandPaymentScreen extends StatefulWidget {

  Map<String, dynamic> selectBroadBandProvider;
  String phoneNumber;

  SelectedBroadBandPaymentScreen({ required this.selectBroadBandProvider, required this.phoneNumber, super.key});

  @override
  State<SelectedBroadBandPaymentScreen> createState() => _SelectedBroadBandPaymentScreenState();
}

class _SelectedBroadBandPaymentScreenState extends State<SelectedBroadBandPaymentScreen> {
                  ...
                  children: [
                    ListTile(
                      ...
                      leading: SizedBox(
                        width: 50,
                        height: 50,
                        child: Image.asset(widget.selectBroadBandProvider["broadBandProviderLogo"]),
                      ),
                      title: Text(widget.selectBroadBandProvider["broadBandProviderName"], style: const TextStyle(
                          fontFamily: "Montserrat",
                          fontSize: 16,
                      ...
                      subtitle: Text(widget.phoneNumber, style: const TextStyle(
                        fontFamily: "Montserrat",
                        fontSize: 16,
                      )),
                    ),
