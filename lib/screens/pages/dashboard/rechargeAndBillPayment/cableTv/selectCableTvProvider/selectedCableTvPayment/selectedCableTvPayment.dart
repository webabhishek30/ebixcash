...
class SelectedCableTvPaymentScreen extends StatefulWidget {

  Map<String, dynamic> selectCableTvProvider;
  String mobileOrAccountNumber;

  SelectedCableTvPaymentScreen({required this.selectCableTvProvider, required this.mobileOrAccountNumber, super.key});

  @override
  State<SelectedCableTvPaymentScreen> createState() => _SelectedCableTvPaymentScreenState();
}

class _SelectedCableTvPaymentScreenState extends State<SelectedCableTvPaymentScreen> {
                  ...
                  children: [
                    ListTile(
                      ...
                      leading: SizedBox(
                        width: 50,
                        height: 50,
                        child: Image.asset(widget.selectCableTvProvider["cableTvProviderLogo"]),
                      ),
                      title: Text(widget.selectCableTvProvider["cableTvProviderName"], style: const TextStyle(
                          fontFamily: "Montserrat",
                          fontSize: 16,
                      ...
                      subtitle: Text(widget.mobileOrAccountNumber, style: const TextStyle(
                        fontFamily: "Montserrat",
                        fontSize: 16,
                      )),
                    ),
