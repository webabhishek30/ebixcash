...
class SelectedWaterBillerPaymentScreen extends StatefulWidget {

  Map<String, dynamic> selectedWaterProvider;
  String kNumber;

  SelectedWaterBillerPaymentScreen({required this.selectedWaterProvider, required this.kNumber, super.key});

  @override
  State<SelectedWaterBillerPaymentScreen> createState() => _SelectedWaterBillerPaymentScreenState();
}

class _SelectedWaterBillerPaymentScreenState extends State<SelectedWaterBillerPaymentScreen> {
                  ...
                  children: [
                    ListTile(
                      ...
                      leading: SizedBox(
                        width: 50,
                        height: 50,
                        child: Image.asset(widget.selectedWaterProvider["waterProviderLogo"]),
                      ),
                      title: Text(widget.selectedWaterProvider["waterProviderName"], style: const TextStyle(
                          fontFamily: "Montserrat",
                          fontSize: 16,
                      ...
                      subtitle: Text(widget.kNumber, style: const TextStyle(
                        fontFamily: "Montserrat",
                        fontSize: 16,
                      )),
                    ),
