...
class SelectLpgPaymentScreen extends StatefulWidget {


  Map<String, dynamic> selectLpgProvider;
  String mobileOrConsumerNumber;

  SelectLpgPaymentScreen({ required this.selectLpgProvider, required this.mobileOrConsumerNumber, super.key});

  @override
  State<SelectLpgPaymentScreen> createState() => _SelectLpgPaymentScreenState();
}

class _SelectLpgPaymentScreenState extends State<SelectLpgPaymentScreen> {
                  ...
                  children: [
                    ListTile(
                      ...
                      leading: SizedBox(
                        width: 50,
                        height: 50,
                        child: Image.asset(widget.selectLpgProvider["lpgProviderLogo"]),
                      ),
                      title: Text(widget.selectLpgProvider["lpgProviderName"], style: const TextStyle(
                          fontFamily: "Montserrat",
                          fontSize: 16,
                      ...
                      subtitle: Text(widget.mobileOrConsumerNumber, style: const TextStyle(
                        fontFamily: "Montserrat",
                        fontSize: 16,
                      )),
                    ),
