...
class SelectedElectricityBillerPaymentScreen extends StatefulWidget {

  Map<String, dynamic> selectedElectricityProvider;
  String electricityCANumber;

  SelectedElectricityBillerPaymentScreen({required this.selectedElectricityProvider, required this.electricityCANumber, super.key});

  @override
  State<SelectedElectricityBillerPaymentScreen> createState() => _SelectedElectricityBillerPaymentScreenState();
}

class _SelectedElectricityBillerPaymentScreenState extends State<SelectedElectricityBillerPaymentScreen> {
                  ...
                  children: [
                    ListTile(
                      ...
                      leading: SizedBox(
                        width: 50,
                        height: 50,
                        child: Image.asset(widget.selectedElectricityProvider["electricityProviderLogo"]),
                      ),
                      title: Text(widget.selectedElectricityProvider["electricityProviderName"], style: const TextStyle(
                          fontFamily: "Montserrat",
                          fontSize: 16,
                      ...
                      subtitle: Text(widget.electricityCANumber, style: const TextStyle(
                        fontFamily: "Montserrat",
                        fontSize: 16,
                      )),
                    ),
